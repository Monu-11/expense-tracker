        ...
        <div>
            {expenses.length===0?<h2>No expenses found</h2>:
                        ...
                        {currentExpenses.map((expense)=>{
                            return <tr key={expense._id} style={{textDecoration:expense.isDeleted?'line-through':'none'}}>
                                <ExpenseItem expense={expense} categories={props.categories} />
                            </tr>
                                })}                 
            ...
            <Pagination expensesPerPage={expensesPerPage} totalExpenses={expenses.length} paginate={paginate}/>
        </div>
    )
}
