...
import registerImage2 from '../img/registerImage2.avif'
...
const RegisterForm=(props)=>{
    ...
    const runValidators=()=>{
        ...
        if(password.length>0&&password.length<5){
            errors.passwordError='Password is too short. Length must be greater than 5.'
        }
        console.log(errors)
    }
    ...
    return (
        <div className='registerPage' style={{backgroundImage:`url(${registerImage2})`, backgroundSize:'cover'}}>
            ...
            <form onSubmit={handleSubmit}>
                ...
                <input type='password' className='form-control' placeholder='Create a password' value={password} name='password' onChange={handleChange}/><br />
